let french = {
  ...
  helmet: `Website da Orquestra Sanfônica Balaio Nordeste`,
  ...
  landingPage: {
    infoSection: {
      ...
      infoContainer__text4: `Le défi consiste à faire en sorte que OSBN ait un calendrier de présentations permanent, soit dans l’état, soit au Brésil et dans d’autres pays.`,
      infoContainer__text5: `Le répertoire de l'orchestre présente de grands maîtres de la musique brésilienne, tels que Luiz Gonzaga, Jackson do Pandeiro, Chico César, Sivuca, entre autres, amenant le public à chanter et à danser au son des cirandas, coco de roda, baião, xote, et beaucoup pour foro.`,
    },

    historySection: {
      transitionDiv: `Historique`,
    },

    gallerySection: {
      transitionDiv: `Galerie`,
      galleryButton: `Aller à la Galerie!`,
    },

    scheduleSection: {
      transitionDiv: `Agenda`,
    },
    ...
    technicalSection: {
      transitionDiv: `Répertoire`,
      musicContainer__table__music: `Musique`,
      musicContainer__table__composer: `Compositeur`,
    },

    contactSection: {
      transitionDiv: `Nous contacter`,
      social: `Suivez nous sur les réseaux sociaux!`,
      contact: `Contactez nous`,
      wpp: `Contact de production: (83) 99922-3749`
    },
  },

  gallery: {
    helmet: `Galerie d'images de l'Orchestre Balaio Nordeste Sanfônica`,
    transitionDiv: `Galerie`,
    button: `& Début`,
  },
  ...
  sideMenu: {
    ...
    newsButton: `Nouvelles`,
    technicalButton: `Répertoire`,
    socialButton: `Social`,
  }
};
