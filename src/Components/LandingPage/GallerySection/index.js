        ...
        return (
            <>
                <IntersectionVisible onShow={e => this.onShow(e)}>
                    <div ref={this.props.forwardRef} className="gallery-section">
                        ...
                        <NavLink to="/gallery" className="gallery-section-galleryButton">{this.props.language === 'portuguese' ? 'Ir para Galeria!' :
